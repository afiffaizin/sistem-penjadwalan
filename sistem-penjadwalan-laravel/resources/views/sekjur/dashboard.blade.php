...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div
                class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex justify-between items-center relative overflow-hidden">
                ...
                <div
                    class="w-12 h-12 bg-amber-50 rounded-lg flex items-center justify-center text-amber-500 text-xl shadow-sm border border-amber-100">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                @if ($jumlahMatkul > 0)
                    <a href="{{ route('matkul.index') }}"
                        class="text-xs font-semibold text-gray-500 hover:text-amber-500 transition flex items-center gap-1">
            ...
            @else
                <div
                    class="border-2 border-dashed border-gray-200 bg-gray-50/50 rounded-2xl p-10 flex flex-col items-center justify-center text-center">
                    <div
                        class="w-16 h-16 bg-white rounded-full shadow-sm flex items-center justify-center mb-5 text-gray-400 text-2xl border border-gray-100">
                    ...
                    <p class="text-gray-500 max-w-lg mb-8 text-sm leading-relaxed">
                        Silahkan selesaikan proses upload data dan cleansing untuk melihat statistik mendalam mengenai
                        distribusi jam kuliah dan ketersediaan ruangan.
                    </p>

                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="{{ route('upload.form') }}"
                            class="px-6 py-2.5 bg-amber-500 hover:bg-amber-600 text-white text-sm font-semibold rounded-full transition shadow-md shadow-amber-200 border border-transparent">
                            Mulai Upload Data
                        </a>
                        <a href="#"
                            class="px-6 py-2.5 bg-white border border-gray-300 hover:border-amber-500 hover:text-amber-600 text-gray-600 text-sm font-semibold rounded-full transition shadow-sm">
                            Pelajari Sistem
                        </a>
                    </div>
                </div>
