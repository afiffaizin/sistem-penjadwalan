...
<div class="container mx-auto max-w-7xl">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 mb-6 border-l-8 border-amber-600">
        ...
        <p class="text-gray-500 text-sm mb-6">Gunakan filter di bawah ini untuk meninjau keseluruhan matriks jadwal perkuliahan lintas program studi.</p>
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center gap-3 mt-4 pt-4 border-t border-gray-100">
                <div class="flex flex-wrap gap-2 w-full sm:w-auto">
                    @if(request()->anyFilled(['dosen_id', 'kelas_id', 'ruang_id', 'prodi_id']))
                        <button type="submit" formaction="{{ route('jadwal.export.excel') }}" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-sm font-bold transition shadow-sm">
                            <i class="fa-solid fa-file-excel text-base"></i><span>Export Excel</span>
                        </button>
                        <button type="submit" formaction="{{ route('jadwal.export.pdf') }}" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-rose-600 hover:bg-rose-700 text-white rounded-lg text-sm font-bold transition shadow-sm">
                            <i class="fa-solid fa-file-pdf text-base"></i><span>Export PDF</span>
                        </button>
                    @endif
                </div>
                <div class="flex w-full sm:w-auto justify-end gap-3">
                    <a href="{{ route('kajur.jadwal') }}" class="px-5 py-2.5 bg-gray-100 text-gray-600 rounded-lg text-sm font-bold hover:bg-gray-200 transition min-w-[80px] text-center">Reset</a>
