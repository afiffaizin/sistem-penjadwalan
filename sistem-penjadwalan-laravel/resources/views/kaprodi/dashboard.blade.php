...
<div class="container mx-auto max-w-7xl">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 flex flex-col lg:col-span-2">
            <h3 class="text-lg font-extrabold text-gray-800 mb-2"><i class="fa-solid fa-chart-column mr-1 text-amber-500"></i> Kepadatan Jadwal Per Hari</h3>
            <p class="text-xs text-gray-500 mb-6 font-medium">Distribusi total sesi perkuliahan aktif berdasarkan hari kerja.</p>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 flex flex-col">
            <h3 class="text-lg font-extrabold text-gray-800 mb-2"><i class="fa-solid fa-chart-pie mr-1 text-amber-500"></i> Kategori Perkuliahan</h3>
